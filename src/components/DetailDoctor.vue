        ...
        <div class='left'>
          ...
          <div class='user-info'>
            ...
            <table class="results">
                        ...
                        <tr class="result-description">
                            <td class="result-description__concept">Profesional Card</td>
                            <td class="result-description__value" >{{usr.professional_card}}</td>
                        </tr>
                        <tr class="result-description">
                            <td class="result-description__concept">Speciality</td>
                            <td class="result-description__value" >{{usr.speciality}}</td>
                        </tr>
