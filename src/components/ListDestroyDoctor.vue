        ...
        <section class="hero is-medium is-info is-bold">
            <div class="hero-body">
                <div class="container mt-5 pb-5">
                    <h1 class="title">Doctor's Data table</h1>
                </div>
            </div>
        </section>
...
export default {
    ...
    methods: {
        getData: async function () {
            ...
            axios.all([axios.get('http://127.0.0.1:8000/user/'),axios.get('http://127.0.0.1:8000/medic/')])
...
table td button .fa-search {
    color: #3b5998;
}
table td button .fa-pen {
    color: #FFC107;
}
