  ...
  <div class="signUp_user">
    <div class="container_signUp_user">
      ...
      <section class="register">
        ...
        <h2 class="register-title">Famliar Update Form</h2>
          ...
          <section v-show="step === 2">
            <form class="form" method="post" action="javascript:void(0)">
              ...
              <div class="form-group">
                ...
                <input type="text" name="relationship" id="relationship" v-model="usr.relationship"
                  autocomplete='usr.speciality' placeholder="Relationship" required />
              </div>
              ...
              <div class="form-group">
                <input type="email" name="e_mail" id="e_mail" v-model="usr.user.e_mail" autocomplete='usr.user.e_mail'
...
export default {
  ...
  methods: {
    getData: async function () {
      ...
      axios.all([axios.get(`http://127.0.0.1:8000/user/${this.$route.params.id}/`), axios.get('http://127.0.0.1:8000/familiar/')])
    ...
    editRecord: async function () {
      ...
      let user = {
            ...
            let familiar = {
                ...
                "relationship": this.usr.relationship
            }

            axios.all([
                axios.put(`http://127.0.0.1:8000/user/${this.$route.params.id}/`, user),
                axios.put(`http://127.0.0.1:8000/familiar/${this.usr.id}/`, familiar)
            ])
