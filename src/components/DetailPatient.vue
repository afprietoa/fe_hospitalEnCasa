        ...
        <div class='left'>
            ...
            <div class='user-info'>
                ...
                <table class="results">
                    ...
                    <tr class="result-description">
                        <td class="result-description__concept">Date of birth</td>
                        <td class="result-description__value">{{usr.birth_date}}</td>
                    </tr>
                    <tr class="result-description">
                        <td class="result-description__concept">Address</td>
                        <td class="result-description__value">{{usr.address}}, {{usr.city}}</td>
                    </tr>
                    <tr class="result-description">
                        <td class="result-description__concept">Geopositioning</td>
                        <td class="result-description__value"> lon: {{usr.address}} <br> lat: {{usr.city}}</td>
                    </tr>
