  ...
  <div class="signUp_user">
    <div class="container_signUp_user">
      ...
      <section class="register">
        ...
        <h2 class="register-title">Doctor Sign Up Form</h2>
          ...
          <section v-show="step === 2">
            <form class="form" method="post" action="javascript:void(0)">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  <input type="number" name="professional_card" id="professional_card" v-model="usr.professional_card" autocomplete="usr.professional_card" required />
                  <input type="text" name="speciality" id="speciality" v-model="usr.speciality" autocomplete='usr.speciality' placeholder="Speciality" required />
              </div>
        ...
        <transition name="slide-fade">
          <section v-show="step === 3">
            <form class="form" action="#" @submit.prevent="processSignUp">
